...
<div class="table-responsive" style="padding: 50px 50px 100px 100px;">
    <%--table-sm--%>
    <a href="/emp?type=input" class="btn btn-sm btn-info" role="button" aria-pressed="true" style="font-size: 7px;">添加</a>
    <table class="table table-sm table-bordered table-hover" style="text-align: center">
        ...
        <tr>
            ...
            <td>${e.address}</td>
            <td>
                <a href="/emp?type=input&id=${e.id}" class="btn btn-sm btn-info" role="button" aria-pressed="true" style="font-size: 7px;">修改</a>
...
<script>
    ...
    function deleteId(){
        ...
        document.getElementById('use').innerText='id='+id;
        document.getElementById('deleteSure').href='/emp?type=delete&id='+id;
    }
</script>
</body>
</html>
